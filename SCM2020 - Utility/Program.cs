...
namespace SCM2020___Utility
{
    class Program
    {
        static Uri uriServer = new Uri("https://localhost:5001/api/");
        const string urlLogin = "https://localhost:5001/api/User/Login";
        const string urlAddUser = "https://localhost:5001/api/User/NewUser";
        const string urlGroups = "https://localhost:5001/api/Group/";
        const string urlAddGroup = "https://localhost:5001/api/Group/Add";
        const string urlAddProduct = "https://localhost:5001/api/GeneralProduct/Add";
        const string urlVendor = "https://localhost:5001/api/Vendor/Add";
