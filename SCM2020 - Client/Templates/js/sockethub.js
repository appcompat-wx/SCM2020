"use strict"
var connection = new signalR.HubConnectionBuilder().withUrl("https://localhost:52992/sockethub", { skipNegotiation: true, transport: signalR.HttpTransportType.WebSockets  }).build();
